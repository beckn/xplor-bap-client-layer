...
export const Endpoints = {
  ...
  getVcWalletCertificateUploadUrl: '/api/v1/wallet/file/certificate',
  ...
  subscribeToKafkaCatalogue: '/app/v1/subscribe',
  getSupportedLanguageUrl: '/api/v1/ai-ml/supported-languages',
  getSearchItems: '/app/v1/search',
  getGclSearchItems: '/search',
  ...
  getPaymentLink: '/api/v1/payment/create-link',
  verifyPayment: '/api/v1/payment/verify',
  getPaymentVerifyUrl: '/api/v1/payment/verify-payment',
  getGclSelectUrl: '/api/v1/stg/select',
  getGclInitUrl: '/api/v1/stg/init',
  getGclConfirmUrl: '/api/v1/stg/confirm',
  getGclStatusUrl: '/api/v1/stg/status',
  getGclRateUrl: '/api/v1/stg/rating',
  getGclCancelUrl: '/api/v1/stg/cancel',
  getGclUpdateUrl: '/api/v1/stg/update',
  getGclSupportUrl: '/api/v1/stg/support',
  getGclTrackUrl: '/api/v1/stg/track',
  getGclSearchUrl: '/api/v1/stg/search',
};
